from gametasksAnswers import printInstructions, getUserScore, updateUserScore
from gameclassesAnswers import Game, MathGame, BinaryGame
...
try:
    ...
    binaryInstructions = '''In this game, you will be given a number in base 10. You task is to convert this number to base 2. Each correct answer gives you one mark. No mark is deducted for wrong answers.'''
    mg = MathGame()
    bg = BinaryGame()
    ...
    while userChoice != '-1':
        ...
        userChoice = input("\nPress Enter to continue of -1 to end: ")
